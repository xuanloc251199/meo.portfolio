  ...
  <div class="avatar__container d-flex flex-column justify-content-lg-between">
    ...
    <div class="avatar__block">
      <div class="avatar__logo d-flex align-items-center">
        ...
        <div class="logo__caption">
          <p>{!! $settings['logo_caption'] ?? '' !!}</p>
        </div>
      </div>
      <div class="avatar__image">
        <img src="{{ str_starts_with($settings['avatar_image'] ?? 'img/avatars/avatar.png', 'img/') ? asset($settings['avatar_image'] ?? 'img/avatars/avatar.png') : asset('storage/'.$settings['avatar_image']) }}" alt="{{ $settings['name'] ?? '' }}">
      </div>
    </div>
    <!-- data caption #1 -->
    <div class="avatar__block">
    ...
    <div class="avatar__block">
      <div class="avatar__socials">
        <ul class="socials-square d-flex justify-content-evenly">
          <li class="socials-square__item">
            <a class="socials-square__link btn" href="{{ $settings['facebook_url'] ?? '#' }}" target="_blank"><i class="ph-bold ph-facebook-logo"></i></a>
          </li>
          <li class="socials-square__item">
            <a class="socials-square__link btn" href="{{ $settings['instagram_url'] ?? '#' }}" target="_blank"><i class="ph-bold ph-instagram-logo"></i></a>
          </li>
        </ul>
      </div>
